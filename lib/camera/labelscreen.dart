...
import 'package:dr_green/camera/automl_api.dart';
import 'package:dr_green/camera/collaborators_page.dart';
import 'package:dr_green/camera/constants.dart';
import 'package:dr_green/camera/label_samples_grid.dart';
import 'package:dr_green/camera/models.dart';
import 'package:dr_green/camera/operations_page.dart';
import 'package:dr_green/camera/service.dart';
import 'package:dr_green/camera/user_model.dart';
import 'package:dr_green/camera/widgets/dismissible_warning.dart';
import 'package:dr_green/camera/widgets/rotating_progress_icon.dart';
...
class _ListLabelsScreenState extends State<ListLabelsScreen> {
  ...
  Widget build(BuildContext scaffoldContext) {
    return Consumer<UserModel>(builder: (context, _, model) {
      final isOwner = widget.dataset.isOwner(_);
      final isCollaborator = widget.dataset.isCollaborator(_);
...
class LabelEntry extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return new Consumer<UserModel>(builder: (context, _, model) {
      return new ListTile(
        title: new Container(
          child: InkWell(
